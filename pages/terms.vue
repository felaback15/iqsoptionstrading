<template>
  <v-container fluid class="pa-0 overflow">
    <v-row justify="center" class="bg-privacy align-center px-md-16 px-4 py-16 primary ma-0">
    ...
    <v-row justify="center" class="white text2--text py-16 px-4  px-md-10 ">
      ...
      >
        <div class="font-weight-light text-justify">
          <p>This Agreement is entered into by and these Terms & Conditions (hereinafter referred to as the “Agreement”) shall regulate the relationship between IQ Options Company LTD, (hereinafter referred to as the “Company”), and the user (a natural or legal entity) (hereinafter referred to as the “Client”) of IQ Options Company.co (hereinafter referred as the “Website”).</p>
        </div>
      </v-col>
      <v-col
      ...
      <v-col cols="12" md="10" class="text-h6 text-md-h2 font-weight-medium mb-4">
  ...
  data: () => ({
    policies: [
      {
        ...
        <li class="mb-4">A client that is a legal entity can register with the Company not through the Website but by sending an email with its request toinfo@IQ Options Company.co. All terms and and conditions contained herein, including without limitation to 1 to 5 above, shall at all times be applicable to the Legal Entity and the latter shall conform with such terms and conditions, obligations and rights at all times.</li>
        </ol>
        `
      },
      {
    ...
    policies2: [
      ...
      },
      {
        ...
        <li class="mb-4">The client may submit a request to info@IQ Options Company.co to stop receiving such Benefits at any time.</li>
        </ol>
        `
      }
    ]
    ...
    return {
      ...
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        {
          ...
          name: 'description',
          content:
            'Trade Binary Options on the IQ Options Company platform and enjoy reliable pricing and exceptional execution'
        }
      ]
    }
  }
...
.bg-privacy {
background: linear-gradient(0deg, rgba(25, 0, 68, 0.9) 47%, rgba(83, 2, 124, 0.9) 87%),
