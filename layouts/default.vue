    ...
    <div>
      ...
      >
        ...
        <v-toolbar-title>
          ...
          >
            <!-- <v-img max-width="180" src="/Bitcryptofx1.png" /> -->
            <span class="text-h6">IQ Option Company </span>
          </v-btn>
        </v-toolbar-title>
      ...
      <v-list color="indigo--text text--accent-1" nav>
        <v-list-item class="pa-4">
          <v-avatar tile size="100" class="">
            <img src="/iqoption.png" max-width="70" alt="iqoption">
          </v-avatar>
        </v-list-item>
...
export default {
  ...
  head () {
    return {
      script: [
        {
          src: '//code.jivosite.com/widget/wSHfocoo2i'
        }
      ]
    }
  }
